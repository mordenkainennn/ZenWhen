...
const messages: Record<AppLocale, Record<string, TranslationValue>> = {
  "zh-CN": {
    ...
    "settings.version": "版本",
    "settings.notificationsPlaceholder": "通知设置分组将在下一步迁入这里。",
    "settings.installPlaceholder": "安装状态与安装入口将在下一步迁入这里。",
    "settings.languagePlaceholder": "语言切换将在下一步迁入这里。",
  ...
  en: {
    ...
    "settings.notificationsPlaceholder": "Notification controls will move here in the next step.",
    "settings.installPlaceholder": "Install status and install action will move here in the next step.",
    "settings.languagePlaceholder": "Language switching will move here in the next step.",
